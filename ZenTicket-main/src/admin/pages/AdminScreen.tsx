      ...
      <div className="bg-white border border-slate-200/70 rounded-3xl p-5 shadow-2xs space-y-4 text-left">
        ...
        <div className="flex items-center gap-4 pt-1">
          ...
          <button
            ...
            className="zt-btn-secondary group shrink-0 flex items-center justify-between gap-1.5 py-2 px-3.5 font-extrabold text-[10px] uppercase tracking-wider rounded-xl cursor-pointer select-none"
          >
