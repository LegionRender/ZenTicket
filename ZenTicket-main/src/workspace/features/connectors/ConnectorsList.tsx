      ...
      <div className="lg:col-span-2 bg-white border border-slate-200/40 rounded-3xl p-6 shadow-sm flex flex-col justify-between relative overflow-hidden min-h-[480px]">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2.5 shrink-0">
                      <a
                        ...
                        className="text-[10.5px] zt-btn-secondary px-2.5 py-1.5 rounded-lg flex items-center gap-1 font-black"
                      >
          ...
          <div className="mt-3.5 relative z-10 flex gap-2.5">
            {visibleCount < mainFilteredConnectors.length ? (
              <button
                ...
                className="zt-btn-secondary group flex-1 py-3 px-4.5 font-black text-[11px] uppercase tracking-wider rounded-xl flex items-center justify-center gap-2 cursor-pointer"
              >
        ...
        <div className="mt-3.5 pt-3.5 border-t border-slate-100/80 relative z-10">
          <button
            ...
            className="zt-btn-secondary group w-full py-3.5 px-4.5 font-black text-[11px] uppercase tracking-wider rounded-xl flex items-center justify-center gap-2 cursor-pointer"
          >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 shrink-0">
                            ...
                            <a
                              ...
                              rel="noopener noreferrer"
                              onClick={(e) => e.stopPropagation()}
                              className="text-xs zt-btn-secondary px-3 py-1.5 rounded-lg flex items-center gap-1 font-black"
                            >
                              <Link2 className="w-3.5 h-3.5 shrink-0" />
