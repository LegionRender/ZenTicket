              ...
              <div className="bg-white border border-[#EBF1FF] rounded-2.5xl p-4.5 shadow-2xs space-y-4 select-none">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="zt-btn-secondary text-[11px] font-extrabold px-3.5 py-2.5 rounded-xl cursor-pointer"
                  >
                    Ver recibos
                  </button>
                </div>
                ...
                <div className="space-y-4 pt-1">
                  ...
                  <div className="bg-white border border-slate-200/60 rounded-3xl p-5 shadow-[0_3px_10px_rgba(0,0,0,0.01)] relative text-left">
                    ...
                    <button 
                      ...
                      className="zt-btn-secondary w-full text-xs font-black py-3 rounded-xl cursor-pointer text-center"
                    >
                      Elegir Plan Empresa
                    </button>
                  </div>
  ...
  return (
    <div id="account-tab-dashboard" className="max-w-6xl mx-auto space-y-8 font-body text-left animate-fade-in_50 pb-8 select-none">
      ...
      <div className="bg-white border border-slate-200/40 rounded-3xl p-5 shadow-sm flex items-center justify-between font-body">
        ...
        <button
          onClick={() => setIsEditingFiscal(true)}
          className="zt-btn-secondary text-xs font-bold px-4 py-2 rounded-xl cursor-pointer"
        >
          Editar
        </button>
      </div>
      ...
      <div className="lg:col-span-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="zt-btn-secondary group flex items-center justify-between gap-1.5 py-1.5 px-3 font-extrabold text-[9.5px] uppercase tracking-wider rounded-xl cursor-pointer select-none"
          >
                ...
                <div className="flex items-center gap-2">
                  {card.isDefault ? (
                    ...
                    <button 
                      ...
                      className="zt-btn-secondary text-[8.5px] font-black px-2.5 py-1 rounded cursor-pointer uppercase tracking-wider"
                    >
                      Predeterminar
                    </button>
                  )}
      ...
      <div className="space-y-4 pt-4">
        ...
        <button
          ...
          className="zt-btn-secondary w-full py-4 font-black text-sm rounded-2xl flex items-center justify-center gap-2 cursor-pointer"
        >
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-2.5xl p-5 space-y-3.5 text-left animate-fade-in">
            ...
            <div className="flex gap-2.5 pt-1">
              ...
              <button
                ...
                className="zt-btn-secondary flex-1 py-3 font-black text-xs rounded-xl uppercase tracking-wider cursor-pointer"
              >
                Cancelar
              </button>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-50 rounded-2xl p-3 flex flex-col gap-2 border border-slate-200/50 text-center">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="zt-btn-secondary text-[10px] font-black py-1.5 px-2 rounded-xl cursor-pointer text-center"
                      >
                        OTP: 481920
                      </button>
                      <button
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className="zt-btn-secondary flex-1 text-xs font-black py-3 rounded-xl cursor-pointer text-center"
                    >
                      Cancelar
                    </button>
                    <button
