    ...
    <div className="bg-transparent min-h-[500px] flex flex-col relative overflow-hidden select-none gap-6">
          ...
          <div className="max-w-md bg-white border border-slate-100 rounded-3xl p-8 shadow-2xl flex flex-col items-center space-y-6">
            ...
            <div className="w-full flex gap-3 pt-2">
              <button
                ...
                className="zt-btn-secondary flex-1 py-3 px-4.5 text-xs font-black rounded-xl cursor-pointer text-center"
              >
                Ver Planes
              </button>
      ...
      {activeStep !== "upload" && activeStep !== "tracking" && (
        <div className="bg-white border border-slate-200/60 p-5 rounded-2xl shadow-sm flex flex-col sm:flex-row justify-between sm:items-center gap-4 relative z-10">
          ...
          <button
            onClick={resetAll}
            className="zt-btn-secondary text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 px-5 py-2.5 rounded-xl cursor-pointer font-sans"
          >
        ...
        <div className="flex-1 flex flex-col gap-6 relative z-10 animate-fade-in_50 font-sans">
          ...
          {isOcrLoading ? (
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    className="zt-btn-secondary rounded-2xl p-3.5 flex flex-col justify-between items-start gap-3.5 cursor-pointer relative select-none group text-left h-full min-h-[148px]"
                  >
                    ...
                    if (list.length === 0) {
                      return (
                        <div className="py-8 text-center bg-slate-50 border border-dashed border-slate-200 rounded-2xl">
                          <span className="text-slate-400 text-xs font-bold font-sans">No hay alertas en esta categoría. ¡Operación limpia!</span>
                        </div>
                      );
                    }
                        ...
                        {list.length > 3 && (
                          <div className="pt-2">
                            <button
                              ...
                              className="zt-btn-secondary w-full py-3 text-xs font-black uppercase rounded-xl cursor-pointer flex items-center justify-center gap-1.5"
                            >
                          ...
                          if (list.length === 0) {
                            return (
                              <div className="py-12 text-center bg-slate-50 border border-dashed border-slate-200 rounded-2xl my-auto">
                                <span className="text-slate-400 text-xs font-bold">No hay alertas disponibles en esta categoría.</span>
                              </div>
                            );
                          }
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2.5 border-t border-slate-100/50">
                                  ...
                                  <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
                                    ...
                                    <button
                                      ...
                                      className="zt-btn-secondary text-[10px] font-black px-3 py-1.5 rounded-lg cursor-pointer py-1 sm:py-1.5 grow sm:grow-0 text-center"
                                    >
                                      {n.actionText}
                                    </button>
                                  </div>
              ...
              {/* ====================================================================== */}
              <div id="ai-contingency-panel-card" className="bg-white text-slate-800 rounded-3xl p-6 shadow-2xs space-y-5 text-left relative overflow-hidden border border-slate-200/70">
                ...
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <span className="text-[10px] uppercase font-black text-[#0B53F4]/80 tracking-wider block font-mono">Centro de Comando</span>
                ...
                <div className="space-y-2">
                  ...
                  {(() => {
                    ...
                    if (listToRender.length === 0) {
                      return (
                        <div className="py-8 px-4 text-center bg-slate-50 border border-dashed border-slate-200 rounded-3xl">
                          <CheckCircle className="w-8 h-8 text-emerald-500 mx-auto mb-2" />
                          <span className="text-slate-500 text-xs font-bold block">No tienes casos en contingencia en este momento.</span>
                        ...
                        {listToRender.length > 3 && (
                          <div className="pt-1">
                            <button
                              ...
                              className="zt-btn-secondary group w-full py-3 px-4.5 font-black text-[11px] uppercase tracking-wider rounded-xl cursor-pointer flex items-center justify-center gap-2"
                            >
                ...
                {selectedContingencyTicket && (
                  <div className="bg-slate-50 border border-slate-200 rounded-3xl p-5 space-y-5 animate-fadeIn">
                    {/* Ticket Info header */}
                ...
                {activeExtractedTab === "corroborar" && !isEditing ? (
                  ...
                  <div className="space-y-5 animate-fade-in_50 font-sans">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-1">
                      ...
                      <button
                        onClick={() => setActiveExtractedTab("detalles")}
                        className="zt-btn-secondary text-[10.5px] font-black uppercase tracking-widest flex items-center justify-center gap-2 px-6 py-4 rounded-2xl select-none cursor-pointer"
                      >
                  ...
                  <div className="flex gap-2.5 pt-3.5 justify-end">
                    ...
                    {!checkIsDataIncomplete(extractedData) && (
                      <button
                        ...
                        className="zt-btn-secondary text-[10px] font-bold uppercase tracking-widest px-5 py-3.5 rounded-xl cursor-pointer select-none"
                      >
                        Cancelar
                      </button>
                    )}
          ...
          <div id="automating-panel" className="flex-1 flex flex-col justify-between relative z-10 animate-fade-in_50 font-sans text-left bg-white border border-slate-200/80 rounded-3xl p-4 sm:p-8 shadow-[0_15px_35px_-10px_rgba(37,99,235,0.03)] my-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between sm:items-center border-t border-slate-100 pt-5 mt-2">
              ...
              <button
                ...
                className="zt-btn-secondary w-full sm:w-auto text-center text-[10px] font-black uppercase tracking-wider px-4 py-2.5 rounded-xl cursor-pointer"
              >
        ...
        <div id="tracking-panel" className="flex-1 flex flex-col justify-center items-center text-center p-7 sm:p-10 space-y-6 relative z-10 animate-fade-in_50 bg-white border border-slate-200 rounded-3xl shadow-[0_15px_35px_-10px_rgba(37,99,235,0.03)] font-sans max-w-xl mx-auto my-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md mx-auto pt-4 border-t border-slate-100">
            ...
            <button
              ...
              className="zt-btn-secondary flex-1 py-3 px-4 text-xs font-black uppercase tracking-wider rounded-xl cursor-pointer text-center"
            >
              Volver al inicio
            </button>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center text-center p-8 space-y-5 relative z-10 animate-fade-in_50 bg-white border border-slate-200/50 rounded-3xl shadow-sm">
          ...
          <div className="flex justify-center gap-3 pt-3">
            <button
              ...
              className="zt-btn-secondary text-xs font-black uppercase tracking-wider px-5 py-3.5 rounded-xl cursor-pointer select-none"
            >
              Extraer Otro Ticket
            </button>
