        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <button
              ...
              className="zt-btn-secondary p-2 rounded-full cursor-pointer"
              title="Volver"
            >
      ...
      <div className="lg:col-span-5 space-y-6">
        ...
        <div className="space-y-3.5">
          ...
          <button
            ...
            className="zt-btn-secondary w-full flex items-center justify-center gap-2 py-4 rounded-2xl font-black uppercase text-xs cursor-pointer"
          >
            <span>{"</>"}</span>
            Descargar XML
          </button>
    ...
    <div className="max-w-6xl mx-auto space-y-6 font-body text-left mt-2 relative select-none pb-24 animate-fade-in_50">
      ...
      <div className="flex items-center gap-4 py-2 border-b border-transparent relative">
        <button
          ...
          className="zt-btn-secondary p-2 w-10 h-10 rounded-full cursor-pointer flex items-center justify-center shrink-0"
                    ...
                    <div className="flex justify-between items-center select-none pt-0.5">
                      ...
                      <div className="flex items-center gap-2">
                          ...
                          ticketIdToDelete === t.id ? (
                            <div className="flex items-center gap-1 bg-slate-50 border border-slate-200 px-1.5 py-0.5 rounded-lg text-[9px] font-bold animate-fade-in">
                              ...
                              <button
                                ...
                                className="zt-btn-secondary px-1.5 py-0.5 rounded font-bold cursor-pointer"
                              >
                                No
                              </button>
                            </div>
                        ...
                        <button
                          ...
                          className="zt-btn-secondary group flex items-center justify-between gap-1.5 py-1.5 px-3 font-extrabold text-[10px] uppercase tracking-wider rounded-xl cursor-pointer select-none shrink-0"
                        >
                          <span>Ver detalles</span>
                          <ChevronRight className="w-3.5 h-3.5 opacity-70 transition-transform duration-150 transform group-hover:translate-x-0.5" />
                        </button>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="hidden sm:flex flex-col gap-1.5 min-w-[124px] shrink-0">
                        <button
                          ...
                          className="zt-btn-secondary w-full font-black rounded-xl py-1.5 px-3 text-[10px] uppercase tracking-wider flex items-center justify-center gap-1.5 cursor-pointer"
                        >
                    ...
                    <div className="flex sm:hidden gap-2 mt-0.5">
                      <button
                        type="button"
                        onClick={() => setSelectedInvoiceId(inv.id || null)}
                        className="zt-btn-secondary flex-1 font-black rounded-xl py-2.5 px-3.5 text-[10.5px] uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer min-h-[42px]"
                      >
