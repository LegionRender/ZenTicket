  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      try {
        ...
        if (!userSnap.exists()) {
          try {
            localStorage.setItem("is_new_signup_" + user.uid, "true");
          } catch (e) {
        ...
        console.warn("Sinking Firestore error during Google login due to potential quota exhaustion:", dbErr);
      }
    ...
    try {
      if (mode === "signup") {
        ...
        try {
          ...
          console.warn("Sinking Firestore error during Email signup due to potential quota exhaustion:", dbErr);
        }
