                        ...
                        {list.length > 3 && (
                          <div className="pt-2">
                            <button
                              ...
                              className="w-full py-3 bg-[#ebf1ff] hover:bg-[#ebf1ff]/80 text-[#0B53F4] text-xs font-black uppercase rounded-xl transition duration-150 cursor-pointer flex items-center justify-center gap-1.5 shadow-2xs border-none"
                            >
