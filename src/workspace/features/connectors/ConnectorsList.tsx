      ...
      <div className="lg:col-span-2 bg-white border border-slate-200/40 rounded-3xl p-6 shadow-sm flex flex-col justify-between relative overflow-hidden min-h-[480px]">
          ...
          <div className="mt-3.5 relative z-10 flex gap-2.5">
            {visibleCount < mainFilteredConnectors.length ? (
              <button
                ...
                className="group flex-1 py-3 px-4.5 bg-slate-50 hover:bg-slate-100/90 active:bg-slate-200/60 border border-slate-200 text-slate-700 hover:text-slate-900 font-extrabold text-[11px] uppercase tracking-wider rounded-xl flex items-center justify-center gap-2 transition duration-150 cursor-pointer shadow-3xs"
              >
        ...
        <div className="mt-3.5 pt-3.5 border-t border-slate-100/80 relative z-10">
          <button
            ...
            className="group w-full py-3.5 px-4.5 bg-slate-50 hover:bg-slate-100/90 active:bg-slate-200/60 border border-slate-200 text-slate-700 hover:text-[#0B53F4] hover:border-[#0B53F4]/20 font-extrabold text-[11px] uppercase tracking-wider rounded-xl flex items-center justify-center gap-2 transition duration-150 cursor-pointer shadow-3xs"
          >
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-white border border-slate-200 rounded-[32px] shadow-[var(--shadow-elevated)] p-6 md:p-8 flex flex-col max-h-[85vh] overflow-hidden z-10 text-left font-sans"
            >
